...
/**
 * In Zotero 6, bootstrapped extensions may be loaded before the 'Zotero' object is initialized,
 * so wait for the main window to load and get the Zotero object from there
 */
...
async function startup({ id, version, resourceURI }) {
	...
	// Root URI available as an nsIURI in Zotero 6
	var rootURI  = resourceURI.spec;
